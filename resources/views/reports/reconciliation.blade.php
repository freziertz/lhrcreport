                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover MarkTotal" id="sample_1">
                                            <thead>
                                                <tr>
                                                    <th>Nature of Substantive Case</th>
                                                    <th>Male</th>
                                                    <th>Female</th>
                                                    <th>Total</th>
                                                    <th>Successful</th>
                                            ...
                                            <tr class="font-weight-bold">
                                                ...
                                                <td>{{ $reportTotal['WinTotal'] }}</td>
                                                <td>{{ $reportTotal['PendingTotal'] }}</td>
                                                <td>{{ $reportTotal['LoseTotal'] }}</td>
                                                <td>{{ $reportTotal['TotalStatus'] }}</td>
                                            </tr>
