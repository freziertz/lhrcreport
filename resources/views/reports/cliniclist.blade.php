                                        ...
                                        <table class="table table-striped table-bordered table-hover MarkTotal" id="sample_1">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($reports as $report)
                                                    ...
                                                    <tr >
                                                        <td>{{ $i }}</td>
                                                        <td>{{ $report->clientfirstname }}</td>
                                                        <td>{{ $report->clientmiddlename }}</td>
                                                        <td>{{ $report->clientlastname }}</td>
                                                        <td>{{ $report->clientgender }}</td>
                                                        <td>{{ $report->clientstatus }}</td>
                                                        <td>{{ $report->clientattendeddate }}</td>
                                                        <td>{{ $report->caseunitcategories }}</td>
